...
summary: |-
    ...
    주요 보도 기사: 
     ...
     - [동아사이언스] 눈으로 찾던 2차원 반도체 조각, 자동 선별해 소자까지 제작 ([link](https://www.dongascience.com/ko/news/78850))

    권지민 교수 연구팀이 주도한 이번 연구는 광학 현미경 이미지 분석을 통해 2차원 반도체 조각(flake)을 두께별로 자동 분류하고 전극까지 자동 설계·제작하는 플랫폼을 구현했습니다. 12만 개 이상의 조각과 1,615개의 소자를 분석해 두께에 따른 전하 수송 특성을 통계적으로 규명했으며, 연구 결과는 국제학술지 'Advanced Functional Materials'에 게재되었습니다. 
